        ...
        <div id="connect-section">
          <div className="connect-box">
            <div>
              ...
              <p>
                Write about various aspects at{" "}
                <a
                  href="https://www.quarant9.life/author/sourabh/"
                  rel="noopener noreferrer"
                  target="_blank"
                >
                  QuaRANT9
                </a>{" "}
                and more precisely about JavaScript on{" "}
                <a
                  href="https://medium.com/@guptstagram"
                  rel="noopener noreferrer"
                  target="_blank"
                >
                  Medium
              ...
              <p>
                When I feel like to come out of long code and blog writings I
                love to{" "}
                <a
                  href="https://twitter.com/guptstagram"
                  rel="noopener noreferrer"
                  target="_blank"
                >
                  tweet
              ...
              <p>
                Not good at photos but still on{" "}
                <a
                  href="https://www.instagram.com/guptstagram/"
                  rel="noopener noreferrer"
                  target="_blank"
                >
                  Instagram
            ...
            <div className="connect-icons">
              <div
                className="connect-icon-box"
                onMouseOver={connectIconBoxOpen}
              >
                <svg
              ...
              <a
                className="connect-icons-a"
                href="https://www.linkedin.com/in/guptstagram/"
                rel="noopener noreferrer"
                target="_blank"
              >
                <svg
